...
public class AttackJoystickIntakeControl extends IntakeControl {
  ...
  public AttackJoystickIntakeControl(
      IntakeBase intakeBase, CommandJoystick leftJoystick, CommandJoystick rightJoystick) {
    super(intakeBase);
  ...
  public void execute() {
    ...
    this.kRollersPercent =
        rightJoystick.getHID().getRawButton(4)
            ...
            : rightJoystick.getHID().getRawButton(5) ? RobotConfig.kIntakeReversePercent : 0;
